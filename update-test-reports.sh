...
echo ""
echo "📦 Creating JavaScript data file at root (simulating CI/CD)..."
...
# Generate JavaScript file at root
cat > test-results.js <<EOF
...
echo "📊 Generated: test-results.js (root level)"
echo ""
echo "🌐 View at:"
